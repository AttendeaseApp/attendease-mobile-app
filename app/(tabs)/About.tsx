      ...
      <View>
        ...
        <View>
          ...
          <ThemedText type="default" style={{ marginTop: 10, fontSize: 18 }}>
            ...
            check-ins, and staying connected with your community. Whether
            you&apos;re attending academic or non-academic events, RCians
            Attendease makes it easy to manage your event experiences all in one
            place.
          </ThemedText>
