...
export default function EventDetailsRegistrationPage() {
    ...
    const { latitude, longitude, loading, locationLoading, isPinging, lastPingTime } = useEventCheckIn(parsedEventId!, parsedLocationId!)
    ...
    return (
        <ScreenContainer>
            ...
            <ScrollView contentContainerStyle={{ paddingBottom: 100 }} refreshControl={<RefreshControl refreshing={refreshing} onRefresh={onRefresh} />}>
                ...
                <View style={styles.infoSection}>
                    <ThemedText type="defaultSemiBold">Registration starts at exactly {formatDateTime(eventData?.timeInRegistrationStartDateTime)}.</ThemedText>
            ...
            <View style={styles.fixedButtonContainer}>
                <Button title={loading ? 'REGISTERING...' : 'REGISTER'} onPress={handleRegisterPress} disabled={loading || locationLoading || !latitude || !longitude || isPinging} />
            </View>
        </ScreenContainer>
    )
}
